/**
 * financeCore.ts
 * Stores wealth, finance, investment intelligence.
 */
...
const CORE_PATH = path.join(__dirname, "../../data/cores/finance.json");
...
export function updateFinanceCore(research: any) {
  const core = loadCore();
  ...
  saveCore(core);
  console.log("Finance core updated.");
}
