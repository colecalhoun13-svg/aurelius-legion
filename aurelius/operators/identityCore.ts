/**
 * identityCore.ts
 * Stores identity, mindset, philosophy intelligence.
 */
...
const CORE_PATH = path.join(__dirname, "../../data/cores/identity.json");
...
export function updateIdentityCore(research: any) {
  const core = loadCore();
  ...
  saveCore(core);
  console.log("Identity core updated.");
}
