/**
 * performanceCore.ts
 * Stores performance, movement, biomechanics intelligence.
 */
...
const CORE_PATH = path.join(__dirname, "../../data/cores/performance.json");
...
export function updatePerformanceCore(research: any) {
  const core = loadCore();
  ...
  saveCore(core);
  console.log("Performance core updated.");
}
