/**
 * strategyCore.ts
 * Stores business, systems, strategic intelligence.
 */
...
const CORE_PATH = path.join(__dirname, "../../data/cores/strategy.json");
...
export function updateStrategyCore(research: any) {
  const core = loadCore();
  ...
  saveCore(core);
  console.log("Strategy core updated.");
}
